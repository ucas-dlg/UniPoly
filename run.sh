...
# crowdai 建筑物数据集的配置文件
# CUDA_VISIBLE_DEVICES=2,3,4,5 GPUS_PER_NODE=4 ./tools/run_dist_launch.sh 4  ./configs/CrowdAI/deformable_dert_crowdai_notwostage_dataaug.sh > A_S5_corwdai_buildvfinal2_dataaugv2.log 2>&1  
